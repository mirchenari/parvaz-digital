...
export default function ProductPreview({ product }) {
  return (
    <div className="min-w-[20%] max-w-[20%] flex flex-col items-center gap-3 px-10 py-5 border-l-2 border-l-gray-200">
      <Link
      ...
      >
        ...
        <div className="max-w-[100%]">
          <h4 className="line-clamp-2 text-justify max-w-[100%]">
            {product.title}
          </h4>
        </div>
