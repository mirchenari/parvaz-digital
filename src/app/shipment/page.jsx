...
export default function shipmentPage() {
  ...
  function ChangeAddress() {
    ...
    return (
      ...
      >
        <div className="bg-white min-w-[60%] p-5 rounded-2xl">
  ...
  return (
    logedUser && (
      <>
        ...
        <section className="grid grid-cols-3 gap-10 px-20 my-5">
          <div className="col-span-2">
            <div className="flex flex-col gap-2.5">
              ...
              <div className="bg-[#F3F8FD] rounded-2xl p-5 flex justify-between items-center">
            ...
            <div className="mt-10">
              ...
              <div className="border-2 border-gray-300 rounded-2xl p-5 flex gap-5">
                {products.map((item) => (
                  <div
                    key={item._id}
